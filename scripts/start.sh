...
EOF
    ...
    APPSEC_COLLECTIONS="crowdsecurity/appsec-virtual-patching crowdsecurity/appsec-generic-rules crowdsecurity/appsec-remote-code-execution"
    ...
    echo "   🛡️ AppSec (WAF) is ENABLED. Collections: appsec-virtual-patching, appsec-generic-rules, appsec-remote-code-execution."
else
